    ...
    <div className="flex min-h-screen flex-col">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                  Create, study, and master your subjects with our intelligent
                  flashcard system
                </p>
              </div>
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground md:text-xl">
                  Our spaced repetition algorithm helps you remember more in
                  less time by showing you cards at the optimal moment.
                </p>
              </div>
              ...
              <Tabs defaultValue="create" className="w-full">
                ...
                <TabsContent value="create" className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Create your own flashcards or use our AI to generate them
                ...
                <TabsContent value="study" className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Our spaced repetition algorithm shows you cards at the
                    optimal time for maximum retention.
                  </p>
                  <div className="flex justify-center mt-4">
                    <Button
                      variant="outline"
                ...
                <TabsContent value="master" className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Track your progress and see your knowledge grow over time
                ...
                <Card>
                  <CardContent className="p-6 flex flex-col items-center">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      textbooks, or any text using our advanced AI.
                    </p>
                  </CardContent>
                </Card>
                <Card>
      ...
      <footer className="border-t py-6 md:py-0">
        <div className="container flex flex-col items-center justify-between gap-4 md:h-16 md:flex-row">
          <p className="text-sm text-muted-foreground">
            © 2025 SmartCard. All rights reserved.
          </p>
